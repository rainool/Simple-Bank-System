...
namespace BankSystem
{
    internal class DepositTransaction
    {
        ...
        public void Print()
        {
            ...
            Console.WriteLine($"Deposit Amount: {_amount.ToString("C", CultureInfo.GetCultureInfo("en-US"))}");
        ...
        public void Execute()
        {
            ...
            {
                _success = false;
                throw new InvalidOperationException("Cannot deposit null or negative amount.");
            }
        }
